...
/* External objects */
extern ray_intg line; /* Source code line numbers - defined in scanner.c */
 ...
 * -------------------------------------------------------------
 */
ray_void printScannerError(ray_char* fmt, ...);
ray_void displayScanner(BufferReader* ptrBuffer);
ray_long getScannerFilesize(ray_char* fname);
